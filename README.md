...
🔹 Encontrar, manipular e filtrar dados. <br>
...
O projeto com o codinome All For One tem o objetivo de trabalhar os conceitos iniciais de SQL. Dê boas vindas ao banco de dados Northwind, que será usado neste projeto. Monte queries para encontrar as informações esperadas pelos desafios.

## Estrutura do Projeto

  - Temos, nesse projeto, uma série de desafios com diferentes níveis de complexidade que devem ser resolvidos cada um em seu arquivo próprio.<br><br>
        1. Leia a pergunta e crie na raiz do projeto um arquivo chamado `desafioN.sql`, em que N é o número do desafio;<br>
        2. O arquivo deve conter apenas o código SQL do desafio resolvido. Não se esqueça de incluir o ponto e vírgula (";") no final de suas queries e também de colocar o nome do banco_de_dados.tabela_por_completo, como no exemplo a seguir:<br>
        3. Não é necessário colocar `USE northwind` ou `SET SQL_SAFE_UPDATES = 0;` no início dos seus arquivos. <br>
        4. Após a execução dos teste locais, o banco de dados `northwind` é recriado.
  - 
...
1. Clone o repositório com o comando: `git clone git@github.com:aimemartins/project-all-for-one.git`
2. Entre na pasta do repositório que você acabou de clonar: `cd project-all-for-one`
